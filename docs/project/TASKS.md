...
| V1S1-001 | Implementar V1-S1: ingesta de documentos (upload, auth, tenancy, fingerprint, duplicate detection, idempotency) | director | ACCEPTED | main | 2026-09-04 | Backend FastAPI + SQLAlchemy + Alembic. 41 tests passing. Migraciones 0001+0002. Security invariants verificados. Quality gate superado. Decisiones: SQLAlchemy sync, engine lazy, filesystem storage, magic bytes, SHA-256, bcrypt directo, settings sin cache |
